                ...
                <div class="col-lg-8">
                    <form method="post" action="/dashboard/posts" class="mb-5" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="genre" name="genre" required value="{{ old('genre') }}">
                            @error('genre')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('popularity') is-invalid @enderror" id="popularity" name="popularity" required value="{{ old('popularity') }}">
                            @error('popularity')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('popularity') is-invalid @enderror" id="release_date" name="release_date" required value="{{ old('release date') }}">
                            @error('release date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <input id="overview" type="hidden" name="overview" value="{{ old('body') }}">
